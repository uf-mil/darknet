...
// LIB_API float validate_detector_map(char *datacfg, char *cfgfile, char *weightfile, float thresh_calc_avg_iou, const
// float iou_thresh, int map_points, int letter_box, network *existing_net);
// LIB_API void train_detector(char *datacfg, char *cfgfile, char *weightfile, int *gpus, int ngpus, int clear, int
// dont_show, int calc_map, int mjpeg_port);
// LIB_API int network_width(network *net);
// LIB_API int network_height(network *net);
// LIB_API void optimize_picture(network *net, image orig, int max_layer, float scale, float rate, float thresh, int
// norm);
