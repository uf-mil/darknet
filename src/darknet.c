...
int main(int argc, char **argv)
{
  ...
  {
    gpu_index = -1;
    printf("\n Currently Darknet doesn't support -nogpu flag. If you want to use CPU - please compile Darknet with "
           "GPU=0 in the Makefile, or compile darknet_no_gpu.sln on Windows.\n");
    exit(-1);
  }
