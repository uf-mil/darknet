 ...
 * PThread Functions
 */
PTW32_DLLPORT int PTW32_CDECL pthread_create(pthread_t *tid, const pthread_attr_t *attr,
...
PTW32_DLLPORT void PTW32_CDECL ptw32_push_cleanup(ptw32_cleanup_t *cleanup, ptw32_cleanup_callback_t routine,
                                                  void *arg);
#endif /* PTW32_LEVEL >= PTW32_LEVEL_MAX */
 ...
 */
#define __except                                                                                                       \
  (E) __except ((GetExceptionCode() == ptw32_get_exception_services_code()) ? EXCEPTION_CONTINUE_SEARCH : (E))
